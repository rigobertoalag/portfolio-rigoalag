...
export default function Contact() {
    return (
        <div className="w-full bg-gray-100">
            ...
            <div className="bg-gray-100 flex justify-center h-full w-full pb-10 rounded-lg shadow-lg">
                <div className="h-4/5 w-9/12 flex flex-row bg-gray-100">
                    ...
                    <div className="bg-gray-100 w-1/2 h-full">
                        ...
                        <div className="flex flex-row ml-4 mb-8">
                            <div className="w-52 h-52 bg-gray-200 text-center border-2 rounded border-gray-300 flex flex-col justify-center items-center mx-4 shadow-lg">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-20 w-20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                </svg>
                                <p className="font-bold text-base text-green-900">Celular / Whatsapp:</p>
                                <p className="text-lg text-green-900">+52 314-122-13-91</p>
                            </div>
                            <div className="w-64 h-52 bg-gray-200 text-center border-2 rounded border-gray-300 flex flex-col justify-center items-center mx-4 shadow-lg">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-24" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                                <p className="font-bold text-base text-green-900">Correo:</p>
                                <p className="text-base text-green-900">rigobertoalcantar95@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
